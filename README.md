...
- grounded AI suggestions using local Ollama models, the OpenAI, Anthropic, Google Gemini, or xAI Grok APIs, or OpenRouter;
...
2. Follow the [AI provider guide](docs/AI.md) to use local Ollama, the OpenAI API, the Anthropic API, the Google Gemini API, the xAI Grok API, or OpenRouter.
