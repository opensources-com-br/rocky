...
- sugestões fundamentadas no chat usando modelos locais do Ollama, as APIs da OpenAI, Anthropic, Google Gemini ou xAI Grok, ou OpenRouter;
...
2. Siga o [guia de provedores de IA](docs/AI.pt-BR.md) para usar Ollama local, OpenAI API, Anthropic API, Google Gemini API, xAI Grok API ou OpenRouter.
