...
export default function AppAnswer({ locale }) {
  return <section className="rocky-answer">
    ...
    <div className="rocky-sources"><span>●</span> {localized(locale, "2 on Twitch", "2 na Twitch")} <span className="rocky-evidence">{localized(locale, "View sources", "Ver fontes")}</span></div>
