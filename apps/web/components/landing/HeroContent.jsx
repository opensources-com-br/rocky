...
{localized(locale, "Rocky follows Twitch, Kick, YouTube, Facebook, or TikTok LIVE, groups questions, and helps you check chat through quick actions or voice. Save notes and ideas using local Ollama or your OpenAI, Anthropic, Google Gemini, xAI Grok, or OpenRouter key.", "Rocky acompanha Twitch, Kick, YouTube, Facebook ou TikTok LIVE, agrupa perguntas e ajuda você a consultar o chat por ações rápidas ou voz. Salve notas e ideias usando Ollama local ou sua chave de OpenAI, Anthropic, Google Gemini, xAI Grok ou OpenRouter.")}
</p>
...
<a href={"https://github.com/opensources-com-br/rocky"} target="_blank" rel="noreferrer" style={{"padding": "11px 20px", "borderRadius": "9px", "border": "1px solid rgba(255,255,255,.12)", "background": "rgba(255,255,255,.02)", "color": "rgba(255,255,255,.82)", "fontSize": "14px"}}>
...
{localized(locale, "macOS and Windows · updates from the app", "macOS e Windows · atualizações pelo aplicativo")}
</span>
