...
export default function Showcase() {
  ...
  const [form, setForm] = useState({ name: "", category: "Programação", desc: "", quote: "", platforms: ["Twitch"], urls: { Twitch: "", Kick: "", YouTube: "", Facebook: "" }, provider: "ollama", model: "", voice: "piper", story: "", changes: "" });
  ...
  const values = {
    ...
    readyLabel: complete ? "pronto para enviar" : "preencha nome, frase, resumo e depoimento",
    ...
    cases: visible.map(card), count: `${visible.length} ${visible.length === 1 ? "configuração" : "configurações"}`,
    backToIndex: back,
