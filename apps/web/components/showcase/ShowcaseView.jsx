...
export default function ShowcaseView({ d, backToIndex, cases, chord, copyFile, copyLabel, count, fields, filename, filters, isDetail, isIndex, isSubmit, locale, openSubmit, prSteps, preview, readyLabel, related }) {
  return (<>
...
<ShowcaseIndex cases={cases} count={count} filters={filters} isIndex={isIndex} locale={locale} openSubmit={openSubmit} />
