const content = {
  "group": "Recursos",
  "lead": "A aba Conversa exibe o chat recebido da Twitch, Kick, YouTube ou Facebook. A fila de perguntas organiza uma parte desse conteúdo; o app usa uma conexão de plataforma por sessão.",
  "blocks": [
    {
      "type": "h2",
    ...
    {
      "type": "para",
      "text": "A aba Pulso mostra tendências calculadas das amostras recebidas: mensagens por minuto e espectadores da Twitch, Kick, YouTube ou Facebook conectado. Quedas de conexão ou ausência de dados limitam a leitura."
    }
  ]
};
