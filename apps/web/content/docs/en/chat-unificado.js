const content = {
  ...
  lead: "The Conversation tab displays chat received from Twitch, Kick, YouTube, or Facebook. The question queue organizes part of that content; the app uses one platform connection per session.",
  blocks: [
    ...
    { type: "h2", text: "Pulse" },
    { type: "para", text: "The Pulse tab shows trends calculated from received samples: messages per minute and viewers for the connected Twitch, Kick, YouTube, or Facebook account. Connection drops or missing data limit the reading." }
  ]
};
