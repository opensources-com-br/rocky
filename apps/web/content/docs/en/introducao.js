const content = {
  ...
  blocks: [
    ...
    { type: "list", items: [
      ...
      "Suggestions through Ollama, the OpenAI API, the Anthropic API, or OpenRouter, using a recent chat sample.",
    ...
    { type: "para", text: "This is an alpha version with unsigned development installers. Super Chats, Stars, gifts, message sending, and plugins are not integrated. Kick requires a public HTTPS webhook; Facebook requires a Business app and a Page with an active live video; TikTok uses unofficial WebCast through Eulerstream. The app does not moderate chat or record the stream." },
