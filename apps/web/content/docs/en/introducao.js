const content = {
  ...
  title: "Introduction",
  lead: "Rocky is a desktop assistant for macOS and Windows. The current version follows new messages from your Twitch, Kick, YouTube, or Facebook channel and helps you check chat, organize questions, and save records.",
  blocks: [
    { type: "h2", text: "What works today" },
    { type: "list", items: [
      "Quick analysis actions and, with recognition configured, free-form voice questions.",
      "Suggestions through Ollama, the OpenAI API, or OpenRouter, using a recent chat sample.",
    ...
    { type: "para", text: "This is an alpha version with unsigned development installers. Super Chats, Stars, message sending, and plugins are not integrated. Kick requires a public HTTPS webhook; Facebook requires a Business app and a Page with an active live video. The app does not moderate chat or record the stream." },
