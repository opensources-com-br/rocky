const content = {
  group: "Configuration",
  title: "AI model",
  lead: "Choose the provider under Settings → AI. The current integration offers local Ollama, the OpenAI API, and OpenRouter.",
  blocks: [
    { type: "h2", text: "Ollama" },
    ...
    { type: "h2", text: "OpenAI and OpenRouter" },
    { type: "para", text: "OpenAI uses https://api.openai.com and the Responses API. OpenRouter uses https://openrouter.ai/api; the default model is openrouter/free, whose availability varies. Enter a key and a model available to your account. There is no Anthropic selector or generic OpenAI-compatible integration." },
