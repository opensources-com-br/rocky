const content = {
  ...
  blocks: [
    ...
    { type: "list", items: [
      ...
      "Under AI, choose Ollama, OpenAI API, Anthropic API, or OpenRouter, enter the model, and test the connection. Explicitly save the configuration and key when applicable.",
