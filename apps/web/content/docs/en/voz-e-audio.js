const content = {
  ...
  blocks: [
    ...
    { type: "para", text: "With voice prepared, the listener starts when Twitch, Kick, YouTube, or Facebook connects and can be toggled from the footer. Say “Rocky” followed by your request. The configured agent name acts as the wake word. Ctrl + Shift + F8 interrupts speech and captures a direct command without the wake word. For 12 seconds after an answer, follow-ups such as “explain that,” “summarize that,” and “save that as a note” do not require the name. A new question replaces the previous analysis." },
