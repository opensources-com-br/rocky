const content = {
  "group": "Configuração",
  "lead": "Escolha o provedor em Configurações → IA. A integração atual oferece Ollama local, OpenAI API, Anthropic API e OpenRouter.",
  "blocks": [
    {
      "type": "h2",
      "text": "Ollama"
