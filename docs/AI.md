...
Rocky can generate grounded suggestions from Twitch or Kick chat with local Ollama, the OpenAI Responses API, or OpenRouter.
...
- **Analyze now** works after at least one real Twitch or Kick message arrives.
