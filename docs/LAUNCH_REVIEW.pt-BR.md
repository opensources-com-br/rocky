...
| P2 | Erro de geração ainda pode virar mensagem genérica | Distinguir schema e erros específicos adicionais; timeout, cota e credencial já têm ações recomendadas. Medir latência e consumo; não prometer cancelamento de cobrança |
