...
Outras entregas posteriores, incluindo Kick, YouTube, ElevenLabs, conversa coordenada, fila de perguntas, organização por live, Pulso, backup, diagnóstico e download de atualização, também tornam parte das tabelas histórica. Consulte [Preparação do candidato](RELEASE_PREPARATION.md) para o escopo atual.
...
## O que existia no commit analisado
