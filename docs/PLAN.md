...
> Original reference plan. The current candidate scope is defined in [release preparation](RELEASE_PREPARATION.md); delivery details below are historical and may differ from the implemented order.
