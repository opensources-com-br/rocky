...
> Plano original de referência. O escopo aprovado para o candidato atual está na [preparação de lançamento](RELEASE_PREPARATION.md); os detalhes abaixo são históricos e podem diferir da ordem implementada.
