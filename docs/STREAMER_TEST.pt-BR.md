...
6. Conclua as verificações obrigatórias de plataforma (Twitch, Kick, YouTube ou Facebook) e IA. Confirme que **Concluir configuração** é liberado sem testar a voz; depois configure e teste a voz opcionalmente.
