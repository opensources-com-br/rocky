...
If a Client ID is already configured, connect and authorize your account. Register your own public client only when the field is empty or you prefer your own client.
