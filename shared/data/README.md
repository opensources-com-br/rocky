...
Implements core contracts for Twitch EventSub, Kick webhooks, YouTube and Facebook live-chat polling, Ollama/OpenAI/OpenRouter, ElevenLabs streaming, updates and local SQLite records.
