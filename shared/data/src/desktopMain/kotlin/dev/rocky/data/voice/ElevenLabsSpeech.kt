...
class ElevenLabsSpeech internal constructor(private val player: PcmPlayback, private val newSession: () -> ElevenLabsSession) : SpeechOutput {
    constructor(player: PcmPlayback) : this(player, { ElevenLabsSession() })
    ...
    override fun speak(text: String, configuration: VoiceOutputConfiguration) {
        ...
        firstAudioMillis = 0
        val active = newSession().also { session = it }
        try {
