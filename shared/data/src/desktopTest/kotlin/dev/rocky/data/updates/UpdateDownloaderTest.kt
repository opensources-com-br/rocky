...
class UpdateDownloaderTest {
    ...
    private fun runDownload(body: String, checksum: String = hash, cancel: Boolean = false, offline: Boolean = false) {
        ...
        try {
            if (body == "abc" && checksum == hash && !cancel && !offline) {
    ...
    @Test fun removesOfflineDownload() = runDownload("abc", offline = true)
}
