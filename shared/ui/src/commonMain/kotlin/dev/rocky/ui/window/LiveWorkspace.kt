...
internal class LiveWorkspace(private val records: LocalNotesState) {
    ...
    private val sourceIds = mutableSetOf<String>()
    ...
    fun includes(message: ChatMessage) = sessionId.isNotBlank() && message.sessionId in sourceIds
    ...
    fun finish(timestamp: String): Boolean {
        ...
        summary = text; sessionId = ""; sourceIds.clear()
        return true
    }
}
