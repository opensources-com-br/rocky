...
private val settingsTranslations = mapOf(
    ...
    "Conecte Twitch, Kick ou YouTube e configure a IA para começar pelas ações rápidas. Ative a voz quando quiser." to "Connect Twitch, Kick or YouTube and configure AI to start with quick actions. Enable voice whenever you want.",
    ...
    "Teste a saída com “Testar voz”. Para falar com Rocky, configure whisper.cpp e microfone e use “Testar conversa por voz”." to "Test playback with “Test voice”. To talk to Rocky, configure whisper.cpp and your microphone and use “Test voice conversation”.",
